...
async function getBooks(query) 
{
    ...
    {
        let book = new BookSchema(result.id, result.titulo, result.autor, result.dataDePublicação, result.editora, result.categoria, result.faixaEtaria, result.sinopse, result.ISBN, result.numeroDePaginas, result.alugado);
        books.push(book);
    })
